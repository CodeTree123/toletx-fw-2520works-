                        ...
                        <form class="form-horizontal top-form" action="{{route('shop_search')}}" method="get" role="form">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="checkbox" name="parking" id="ac" value="ac">
                                    <label class="form-check-label checkboxes-label" for="ac">A.C</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="checkbox" name="parking" id="wifi" value="wifi">
                                    <label class="form-check-label checkboxes-label" for="wifi">Wifi</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="checkbox" name="parking" id="roadside" value="roadside">
                                    <label class="form-check-label checkboxes-label" for="roadside">Roadside</label>
                                </div>
                                <div class="form-check form-check-inline ml-3">
                                    <input class="form-check-input" type="checkbox" name="parking" id="shopping_complex" value="shopping_complex">
                                    <label class="form-check-label checkboxes-label" for="shopping_complex">Shopping Complex</label>
                                </div>
                                <div class="mt-3">

                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="checkbox" name="parking" id="lift" value="lift">
                                        <label class="form-check-label checkboxes-label" for="lift">Lift</label>
                                    </div>
                                    <div class="form-check form-check-inline ml-3">
                                        <input class="form-check-input" type="checkbox" name="parking" id="furnished" value="furnished">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check form-check-inline ml-3">
                                            <input class="form-check-input" type="checkbox" name="parking" id="emergency_stair" value="emergency_stair">
                                            <label class="form-check-label checkboxes-label" name="parking" for="emergency_stair">Emergency Stair </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
